...
public class Reports_ProductList_PageObjects {

    //Sidebar Navigation Buttons
    public WebElement Reports_Sidebar(){return getDriver().findElement(By.xpath("//a[normalize-space()='Reports']"));}
    public WebElement ProductLists_Sidebar(){return getDriver().findElement(By.xpath("//a[normalize-space()='Product Lists']"));}
