...
public class Login_PageObjects {
    ...
    public WebElement GSuiteNotification_LoginPage(){return getDriver().findElement(By.xpath("//div[@class='toast-message' and contains(text(), 'Please provide your GSuite credentials.')]"));}
    public WebElement InputPasswordandEmailNotification_LoginPage(){return getDriver().findElement(By.xpath("//div[@class='toast-message' and contains(text(), 'Please provide email or password!')]"));}
    public WebElement InvalidCredentialsNotification_LoginPage(){return getDriver().findElement(By.xpath("//div[@class='toast-message' and contains(text(), 'Invalid Credential')]"));}

    //    Header
    public WebElement UserIcon_Header(){return getDriver().findElement(By.xpath("//span[.='Gwapo ko']"));}
    ...
    public WebElement MLSHOPBranch_Header(){return getDriver().findElement(By.xpath("//span[contains(.,'ML Shop Admin')]"));}
